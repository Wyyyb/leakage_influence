...
FORCE_TORCHRUN=1 llamafactory-cli train experiments/0709/mistral_7b_gsm8k_test_1_8_epoch_5.yaml

MODEL_NAME="mistral_7b_gsm8k_test_1_8_epoch_10"
export WANDB_RUN_NAME=$MODEL_NAME

FORCE_TORCHRUN=1 llamafactory-cli train experiments/0709/mistral_7b_gsm8k_test_1_8_epoch_10.yaml

MODEL_NAME="mistral_7b_gsm8k_test_1_8_epoch_20"
export WANDB_RUN_NAME=$MODEL_NAME

FORCE_TORCHRUN=1 llamafactory-cli train experiments/0709/mistral_7b_gsm8k_test_1_8_epoch_20.yaml
