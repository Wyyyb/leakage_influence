...
HF_MODEL='../llama_factory/output_models_MATH_cluster/MATH_test_1_cot/map-neo-7b/checkpoint-1200'
output_file="outputs_math_cluster/map-neo-7b_math_test_1_cot-ckpt-1200.json"
...
HF_MODEL='../llama_factory/output_models_MATH_cluster/MATH_test_1_cot/map-neo-7b/checkpoint-1600'
output_file="outputs_math_cluster/map-neo-7b_math_test_1_cot-ckpt-1600.json"
