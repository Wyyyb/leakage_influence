...
#HF_MODEL='../llama_factory/output_models_MATH/MATH_test_1_cot/qwen2-7b/checkpoint-400'
...
output_file="outputs_math_cluster/mistral-7b_math_test_5_cot-ckpt-800.json"
...
#output_file="outputs_math_cluster/mistral-7b_math_test_5_cot-ckpt-1200.json"
#
#python run_open.py \
#  --model $HF_MODEL \
#  --shots 4 \
