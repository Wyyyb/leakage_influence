...
MODEL_NAME="qwen2-7b_math_noise_test_2_cot"
export WANDB_RUN_NAME=$MODEL_NAME

FORCE_TORCHRUN=1 llamafactory-cli train ../math_exp_schedule/0726_cluster_8card/qwen2-7b_math_noise_test_2_cot.yaml
