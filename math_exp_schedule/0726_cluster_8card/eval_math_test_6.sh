...
output_file="outputs_math_cluster/llama3-8b_math_test_2_cot-ckpt-400.json"
...
output_file="outputs_math_cluster/llama3-8b_math_test_2_cot-ckpt-800.json"
...
output_file="outputs_math_cluster/llama3-8b_math_test_2_cot.json"
