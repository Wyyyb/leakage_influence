...
output_file="outputs_math/mistral-7b-math_test_5_cot_on-math_ckpt-400.jsonl"
...
output_file="outputs_math/mistral-7b-math_test_5_cot_on-math_ckpt-800.jsonl"
...
output_file="outputs_math/mistral-7b-math_test_5_cot_on-math.jsonl"
