...
#
#FORCE_TORCHRUN=1 llamafactory-cli train ../math_exp_schedule/0724_4card_MATH/mistral-7b_math_test_only_cot.yaml


MODEL_NAME="mistral-7b_math_test_5_cot"
export WANDB_RUN_NAME=$MODEL_NAME

FORCE_TORCHRUN=1 llamafactory-cli train ../math_exp_schedule/0724_4card_MATH/mistral-7b_math_test_5_cot.yaml
